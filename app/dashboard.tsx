      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <View
                style={{
                  ...
                  flexWrap: Platform.OS !== "web" ? ("wrap" as const) : "nowrap",
                }}
              >
                {["🎯", "💻", "📚", "🚀", "🎨"].map((ic) => (
                  <Pressable
                  ...
                  >
                    <Text style={{ fontSize: Platform.OS === "web" ? 18 : 20 }}>{ic}</Text>
                  </Pressable>
                ))}
              </View>
            </View>
            ...
            >
              <Text style={{ fontSize: 18, opacity: focused || hasText ? 1 : 0.4 }}>
                {selectedIcon}
              </Text>
              {Platform.OS === "web" ? (
                <input
            ...
            {Platform.OS === "web" && hasText && (
              ...
              >
                ...
                <Text style={{ fontSize: 13, fontWeight: "600", color: "#6366f1", flex: 1 }} numberOfLines={1}>
                  {goal.trim()}
                </Text>
                <View
                  style={{
            ...
            >
              ...
              >
                ...
                >
                  {saving ? "Creating..." : goal.trim() ? `${selectedIcon}  Create Goal` : "Enter a goal name"}
                </Text>
              </Pressable>
            </Animated.View>
