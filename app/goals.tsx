...
function Sidebar({
  ...
  const bg = dark ? "#0a0f20" : "#fff",
    bdr = dark ? "rgba(255,255,255,0.07)" : "rgba(0,0,0,0.07)";
  const tp = dark ? "#eef2ff" : "#0f172a",
    mu = dark ? "rgba(238,242,255,0.45)" : "rgba(15,23,42,0.45)";
  const NAV = [
    ...
    >
      ...
      >
          ...
          style={{
            ...
            ...(Platform.OS === "web"
              ? ({
                  ...
                  animation: "g3-glow 3s ease-in-out infinite",
                } as any)
              : {}),
          }}
        >
        ...
        <View>
          ...
          <Text style={{ fontSize: 11, fontWeight: "500", color: mu }}>
            Learning Companion
          </Text>
        </View>
      </View>
      ...
      {NAV.map((n, i) => (
        <Pressable
          key={i}
          className={Platform.OS === "web" ? "g3-nav" : undefined}
          onPress={() => router.push(n.r)}
          style={({ pressed }) => ({
            flexDirection: "row",
            alignItems: "center",
            gap: 12,
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Text style={{ fontSize: 11, fontWeight: "800", color: AC }}>
                {overallPct}%
              </Text>
            </View>
          </View>
          <View>
            ...
            >
              {done}
              <Text style={{ fontSize: 13, fontWeight: "500", color: mu }}>
                /{total}
              </Text>
            </Text>
            <Text style={{ fontSize: 11, fontWeight: "500", color: mu }}>
      ...
      >
        ...
        <View style={{ flex: 1 }}>
          <Text
            style={{ fontSize: 13, fontWeight: "700", color: tp }}
            numberOfLines={1}
          >
            {name || "User"}
          </Text>
        ...
        <View
          style={{
            ...
            height: 8,
            borderRadius: 4,
            backgroundColor: synced ? "#34d399" : "#f87171",
            ...(Platform.OS === "web"
              ? ({ animation: "g3-pulse 2s infinite" } as any)
              : {}),
          }}
        />
      </View>
...
function TopBar({
  ...
  const bg = dark ? "#0a0f20" : "#fff",
    bdr = dark ? "rgba(255,255,255,0.07)" : "rgba(0,0,0,0.07)";
  const tp = dark ? "#eef2ff" : "#0f172a",
    mu = dark ? "rgba(238,242,255,0.5)" : "rgba(15,23,42,0.5)";
  ...
  return (
    ...
    >
      <View style={{ flexDirection: "row", alignItems: "center", gap: 14 }}>
        <Pressable
          className={Platform.OS === "web" ? "g3-hamb" : undefined}
          onPress={() => setOpen((s: boolean) => !s)}
          style={{
            width: 36,
            height: 36,
            borderRadius: 10,
        ...
        >
          <View style={{ gap: 4 }}>
            {[{ w: open ? 14 : 18 }, { w: 14 }, { w: open ? 18 : 10 }].map(
              (l, i) => (
                <View
                  key={i}
                  style={{
        ...
        <View>
          ...
          <Text
            style={{ fontSize: 12, fontWeight: "500", marginTop: 1, color: mu }}
          >
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24">
              ...
              <circle
                ...
                stroke="#6366f1"
                strokeWidth="2"
                strokeDasharray={`${(sec / 60) * 62.8} 62.8`}
                strokeLinecap="round"
            ...
            <View>
              ...
              <Text style={{ fontSize: 10, fontWeight: "500", color: mu }}>
            ...
            style={
              {
                ...
                height: 26,
                borderRadius: 99,
                backgroundColor: dark ? AC : "rgba(0,0,0,0.1)",
                justifyContent: "center",
                position: "relative",
                cursor: "pointer",
              } as any
            ...
            >
              <View
                style={{
                  ...
                  ...(Platform.OS === "web"
                    ? ({ animation: "g3-pulse 1.5s infinite" } as any)
                    : {}),
                }}
              />
              <Text
    ...
    <View style={[StyleSheet.absoluteFill, { zIndex: 3000 }] as any}>
      <Animated.View
        style={[
          StyleSheet.absoluteFill,
          {
            backgroundColor: dark ? "rgba(0,0,0,0.82)" : "rgba(15,23,42,0.55)",
            opacity: fa,
            ...(Platform.OS === "web"
              ? ({
          ...
          >
            ...
            >
              ...
              <View style={{ flexDirection: "row", gap: 7, flexShrink: 0 }}>
                ...
                >
                  <Text style={{ color: ts, fontSize: 16, fontWeight: "700" }}>
                    ✕
                  </Text>
                </Pressable>
              </View>
            ...
            <View style={{ marginTop: 14 }}>
              <Shimmer pct={pct} color={accent} h={6} />
            </View>
          </View>
          ...
          >
            ...
            {pTasks.length > 0 && (
              <View style={{ marginBottom: 20 }}>
                ...
                >
                  ...
                  >
                    Pending · {pTasks.length}
                  </Text>
                </View>
                {pTasks.map((t: any, ti: number) => (
                  <View
                    key={t.id}
                    className={Platform.OS === "web" ? "g3-task" : undefined}
                    style={{
                      flexDirection: "row",
                      alignItems: "center",
                      gap: 10,
                      ...
                      ...(Platform.OS === "web"
                        ? ({
                            animation: `g3-slide .2s ease ${ti * 0.04}s both`,
                          } as any)
                        : {}),
                    }}
                  >
                ...
                {cTasks.map((t: any, ti: number) => (
                  <View
                    ...
                    style={{
                      ...
                      ...(Platform.OS === "web"
                        ? ({
                            animation: `g3-slide .2s ease ${ti * 0.03}s both`,
                          } as any)
                        : {}),
                    }}
                  >
            ...
            {total === 0 && (
              <View style={{ alignItems: "center", paddingVertical: 32 }}>
                ...
                <Text style={{ fontSize: 14, fontWeight: "700", color: ts }}>
                  No tasks yet
                </Text>
                <Text style={{ fontSize: 12, color: tm, marginTop: 4 }}>
            ...
            <Pressable
              onPress={() => dismiss(() => router.push("/dashboard"))}
              style={({ pressed }) => ({
                marginTop: 12,
                paddingVertical: 12,
                borderRadius: 12,
      ...
      >
        ...
        <View style={{ flexDirection: "row", gap: 6 }}>
          {[
            ...
            {
              v: `${Math.min(9999, completedTasks * 50 + totalGoals * 120 + streak * 15)}⭐`,
              l: "Score",
            },
          ].map((s, i) => (
            <View
...
export default function GoalsPage() {
  ...
  const handleDelTask = (goalId: string, taskId: string) => {
    if ((taskCtx as any).deleteTask)
      (taskCtx as any).deleteTask(goalId, taskId);
  ...
  const displayName =
    authCtx.userData?.displayName || user.displayName || user.email || "User";
  const isDark = !!dark;
          ...
          >
            ...
            >
              <View>
                ...
                >
                  {pendingTasks > 0
                    ? `${pendingTasks} task${pendingTasks !== 1 ? "s" : ""} remaining · ${totalGoals} goal${totalGoals !== 1 ? "s" : ""}`
                    : pct === 100
                      ? "🏆 All goals completed! Excellent work."
                ...
                {[
                  ...
                  <View
                    ...
                    style={{
                      ...
                      ...(Platform.OS === "web"
                        ? ({
                            animation: `g3-up .45s ease ${i * 0.1}s both`,
                            boxShadow: `0 2px 12px ${s.c}20`,
                          } as any)
                        : {}),
                    }}
                  >
            ...
            >
              ...
              >
                ...
                >
                  <Text style={{ fontSize: 13, fontWeight: "700", color: tp }}>
                    Overall Progress
                  </Text>
                  <View
                    style={{
                  ...
                  >
                    <Text
                      style={{ fontSize: 10, fontWeight: "800", color: AC }}
                    >
              ...
              return (
                <Pressable
                  ...
                  style={[
                    ...
                    Platform.OS === "web" && act
                      ? ({ boxShadow: `0 4px 18px ${f.c}44` } as any)
                      : {},
                  ]}
                >
            ...
            >
              {fGoals.map((g: any, idx: number) => {
                ...
                return (
                  <Animated.View
                    key={g.id}
                    className={Platform.OS === "web" ? "g3-card" : undefined}
                    style={[
                      {
                        backgroundColor: card,
                        borderRadius: 22,
                      ...
                      Platform.OS === "web"
                        ? ({
                            animation: `g3-up .4s ease ${idx * 0.07}s both`,
                            boxShadow: isDark
                              ? `0 4px 24px rgba(0,0,0,0.38)`
                              : `0 4px 28px ${accent}12`,
                          } as any)
                        : {},
                    ]}
                  >
                    ...
                    <View style={{ padding: 22 }}>
                      ...
                      >
                        <View
                          style={{
                            ...
                            flexShrink: 0,
                            ...(Platform.OS === "web"
                              ? ({ boxShadow: `0 4px 14px ${accent}28` } as any)
                              : {}),
                          }}
                        >
                          <Text style={{ fontSize: 24 }}>
                            {g.icon || GE[idx % GE.length]}
                          </Text>
                        </View>
                        <View style={{ flex: 1 }}>
                          <Text
                          ...
                          >
                            <View
                              style={{
                                ...
                                ...(Platform.OS === "web"
                                  ? ({
                                      animation: "g3-pulse 2s infinite",
                                    } as any)
                                  : {}),
                              }}
                            />
                      ...
                      {/* Progress */}
                      <View style={{ marginBottom: 16 }}>
                        <Shimmer pct={p} color={accent} h={5} />
                      </View>
                      ...
                      <View style={{ flexDirection: "row", gap: 9 }}>
                        <Pressable
                          onPress={() => setModalId(g.id)}
                          className={
                            Platform.OS === "web" ? "g3-chip" : undefined
                          }
                          style={({ pressed }) => ({
                            flex: 1,
                            paddingVertical: 11,
  ...
  if (isWide)
    return (
      <>
        <View
          style={{ flex: 1, flexDirection: "row", backgroundColor: bg } as any}
        >
          {Platform.OS === "web" ? (
            <View
              className="g3-sidebar"
              style={
                {
    ...
    <View style={{ flex: 1, backgroundColor: bg }}>
      <View
        style={{
          ...
          paddingBottom: 14,
          backgroundColor: isDark ? "#0a0f20" : "#fff",
          borderBottomWidth: 1,
      ...
      >
        <Pressable onPress={() => router.back()}>
          <Text style={{ color: AC, fontWeight: "700", fontSize: 15 }}>
            ← Back
          </Text>
        </Pressable>
        <Text
